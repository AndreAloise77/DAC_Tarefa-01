...
public class DevAppEx01Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DevAppEx01Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<form action="+"ResultadoServlet"+" method="+"post"+">");
            out.println("<input type=\"text\" name=\"value1\" value=\"\" placeholder=\"Valor1\"><br><br>");
            ...
            out.println("<input type=\"text\" name=\"value2\" value=\"\" placeholder=\"Valor2\"><br><br>");
            out.println("<input type=\"submit\" name=\"calc\" value=\"Calcular\"><br><br>");
            out.println("</form>");
            out.println("</body>");
            out.println("</html>");
    }//func
